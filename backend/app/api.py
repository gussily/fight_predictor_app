...
# with open('jupyter_notebooks/fight_predictor.pkl', 'rb') as f:  
#     fight_predictor = pickle.load(f)
...
@app.get("/predict/")
async def read_item(fighter0: str, fighter1: str):
    return {'data': fp.predict_fight(fighter0, fighter1, name=True)}
    # return {'data': 1}
